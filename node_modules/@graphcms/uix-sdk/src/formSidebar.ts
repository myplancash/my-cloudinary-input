...
import type { Locale } from './type-helpers/locale';
...
export interface FormSidebarExtensionProps
  extends ExtensionPropsBase<FormSidebarExtensionDeclaration> {
  form: Form;
  model: Model;
  /**
   ...
   */
  sidebarConfig?: Record<string, boolean | number | string | undefined | null>;
