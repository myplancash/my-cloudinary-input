          ...
          setName: function (name) {
            return winPromise.then(function (win) {
              ...
              var frame = (function (win) {
                ...
                for (
                  var _i21 = 0,
                    _document$querySelect2 = document.querySelectorAll(
                      'iframe'
                    );
        ...
        var setInternalState = function (newInternalState) {
          return promise_ZalgoPromise.try(function () {
            return setInternalStateOverride
              ...
              : (internalState = _extends({}, internalState, newInternalState));
          });
        };
            ...
            : promise_ZalgoPromise.try(function () {
                if (prerenderTemplate) {
                  ...
                  if (
                    ...
                    var doc = (prerenderWindow = assertSameDomain(
                      prerenderWindow
                    )).document;
                ...
                .then(function (_ref10) {
                  ...
                  if (innerContainer) {
                    ...
                    var containerWatcher = (function (element, handler) {
                      ...
                      (sacrificialFrame = document.createElement(
                        'iframe'
                      )).setAttribute(
                        'name',
                      ...
                      awaitFrameWindow(sacrificialFrame).then(function (
                        ...
                        (sacrificialFrameWin = assertSameDomain(
                          frameWin
                        )).addEventListener('unload', elementClosed);
                      });
                    ...
                    return (currentProxyContainer = getProxyObject(
                      innerContainer
                    ));
                  }
                });
                ...
                var watchForClosePromise = openPromise.then(function (
                  ...
                  !(function watchForClose(proxyWin, context) {
                    ...
                    return promise_ZalgoPromise
                      ...
                      .then(function (isClosed) {
                        return isClosed
                          ? close(new Error('Detected ' + context + ' close'))
                          : cancelled
                          ? void 0
                    ...
                    return promise_ZalgoPromise
                      ...
                      .then(function (win) {
                        if (
                          ...
                          var bridgeUrl =
                            'function' == typeof options.bridgeUrl
                              ? options.bridgeUrl({
                                  props: props,
                                })
                              : options.bridgeUrl;
        ...
        var init = function init(props) {
          ...
          instance = _extends({}, parent.getHelpers(), {
            ...
            clone: function (_temp) {
              ...
              return init(
                (void 0 === _ref3$decorate ? identity : _ref3$decorate)(props)
              );
            },
